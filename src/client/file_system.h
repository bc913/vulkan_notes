#ifndef VULKAN_NOTES_1702330923_FILE_SYSTEM_H
#define VULKAN_NOTES_1702330923_FILE_SYSTEM_H
...
typedef struct file_handle
{
    ...
    // void* because each platform might have different type for file handle
    void *handle;
    b8 is_valid;
} file_handle;
